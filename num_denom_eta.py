...
eta_ele_filthist1 = ROOT.TH1D("eta1_filt_events", "Filtered Events (|eta|<1.0)", len(ele_bin_edges) - 1, ele_bin_edges)
eta_ele_totalhist1 = ROOT.TH1D("eta1_total_events", "Total Events (|eta|<1.0)", len(ele_bin_edges) - 1, ele_bin_edges)
eta_ele_filthist2 = ROOT.TH1D("eta2_filt_events", "Filtered Events (1.0<|eta|<2.0)", len(ele_bin_edges) - 1, ele_bin_edges)
eta_ele_totalhist2 = ROOT.TH1D("eta2_total_events", "Total Events (1.0<|eta|<2.0)", len(ele_bin_edges) - 1, ele_bin_edges)
eta_ele_filthist3 = ROOT.TH1D("eta3_filt_events", "Filtered Events (2.0<|eta|<3.0)", len(ele_bin_edges) - 1, ele_bin_edges)
eta_ele_totalhist3 = ROOT.TH1D("eta3_total_events", "Total Events (2.0<|eta|<3.0)", len(ele_bin_edges) - 1, ele_bin_edges)
