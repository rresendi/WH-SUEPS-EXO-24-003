...
# Loading and combining histograms from all files in a directory
...
for var in variables:
    ...
    legend.AddEntry(data_eff, "Reference Trigger", "lep")
    legend.AddEntry(mc_eff, "No Reference Trigger", "lep")
