...
efficiency = ROOT.TEfficiency(ele_filthist, ele_totalhist)

# Create canvas for efficiency plot
c3 = ROOT.TCanvas("canvas3", "", 800, 600)

# Create legend for efficiency plot
...
# Plot efficiency
c3.cd(1)
efficiency.SetTitle("Electron Trigger Efficiency in bins of pT;Electron pT [GeV];Efficiency")
efficiency.Draw("AP")
legend.Draw()

# Save efficiency plot as PDF
c3.SaveAs(sample_name + "_efficiency_eta_bins.pdf")
